...
## Implemented Models
The code includes three types of RBF models:
...
Three strategies for selecting the shape parameter are implemented in the code:
...
## Key Contributions
The primary contribution of this work is the development and implementation of strategies to transform the reference frame of the sampled data into one where the function response is isotropic. This transformation mitigates the limitations of RBF models that use isotropic basis functions or kernels.
